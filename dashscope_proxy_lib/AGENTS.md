...
- **Module structure**:
  ...
  - `provider_router.py` — `ProviderRouter` routes requests to one of seven providers (primary/secondary/tertiary/quaternary/quinary/senary/septenary) based on model name
